[![Travis build status shield](https://img.shields.io/travis/paultranvan/cozy-dataviz/master.svg)](https://travis-ci.org/paultranvan/cozy-dataviz)
[![Github Release version shield](https://img.shields.io/github/tag/paultranvan/cozy-dataviz.svg)](https://github.com/paultranvan/cozy-dataviz/releases)
...
Hacking the Cozy Cozy Dataviz app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/paultranvan/cozy-dataviz.git
$ cd cozy-dataviz
$ yarn install
```
...
After the build and the stack launched, your app is now available at http://cozy-dataviz.cozy.tools:8080.
...
If you want to work on Cozy Dataviz and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for Cozy Dataviz is [paultranvan](https://github.com/paultranvan), send him/her a :beers: to say hello!
...
Cozy Dataviz is developed by paultranvan and distributed under the [AGPL v3 license][agpl-3.0].
