# How to contribute to Cozy Dataviz?
...
- What is the version of the Cozy Dataviz app?
...
```
$ git clone github.com/paultranvan/cozy-dataviz.git
$ cd cozy-dataviz
$ git remote add fork git://github.com/yourusername/cozy-dataviz.git
```
...
Go to https://github.com/yourusername/cozy-dataviz and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Cozy Dataviz is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/paultranvan/cozy-dataviz/issues/new
...
[localization]: https://github.com/paultranvan/cozy-dataviz/blob/master/README.md#localization
